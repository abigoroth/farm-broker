...
class BrokersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create broker" do
    assert_difference('Broker.count') do
      post brokers_url, params: { broker: { account_no: @broker.account_no, address: @broker.address, dob: @broker.dob, name: @broker.name, phone: @broker.phone } }
    end
  ...
  test "should update broker" do
    patch broker_url(@broker), params: { broker: { account_no: @broker.account_no, address: @broker.address, dob: @broker.dob, name: @broker.name, phone: @broker.phone } }
