...
class FarmersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create farmer" do
    assert_difference('Farmer.count') do
      post farmers_url, params: { farmer: { account_no: @farmer.account_no, address: @farmer.address, dob: @farmer.dob, name: @farmer.name, phone: @farmer.phone } }
    end
  ...
  test "should update farmer" do
    patch farmer_url(@farmer), params: { farmer: { account_no: @farmer.account_no, address: @farmer.address, dob: @farmer.dob, name: @farmer.name, phone: @farmer.phone } }
